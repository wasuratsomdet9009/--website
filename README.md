...
## 5. การยอมรับระบบ (Acceptance Criteria)
...
### 2.1 คุณลักษณะของผู้ใช้งาน (User Characteristics)
...
### 2.2 ข้อสมมุติฐานและข้อจำกัด (Assumptions and Dependencies)
- ผู้ใช้งานทุกคนต้องมีบัญชีอินเทอร์เน็ต
- การแจ้งเตือนผ่าน Email อาศัย SMTP Server ของสถานศึกษา  
- รูปภาพที่อัพโหลดต้องมีขนาดไม่เกิน 5MB ต่อรูป  
...
ระบบบริหารจัดการงานซ่อมบำรุงสำหรับสถานศึกษาที่ออกแบบมาเป็น **Serverless** ที่มีความทันสมัย กระชับ และมีประสิทธิภาพสูงสุด เน้นการใช้งานที่ง่าย (Simple) และภาระการบำรุงรักษาต่ำ (Low Maintenance) 
